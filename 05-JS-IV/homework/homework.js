...
function crearGato(nombre, edad) {
  ...
  // Tu código:
  var gato = {
    nombre: nombre, //Argumento va sin comillas
    edad: edad,
    meow: function () {
      //Agregar método llamado "meow"
      return "Meow!";
    },
  };
  return gato;
...
function tieneEmail(usuario) {
  ...
  //return usuario.hasOwnProperty(email) ? true : false; //no salió
}
...
function verificarPassword(usuario, password) {
  ...
  //return usuario.hasOwnProperty(password) ? true : false; //no sale
}
...
function agregarAmigo(usuario, nuevoAmigo) {
  ...
  // // Tu código:
  usuario.amigos.push(nuevoAmigo); //agrega al final
  return usuario;
}
